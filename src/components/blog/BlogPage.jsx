  ...
  return (
    <>
      <div className="w-[90%] mx-auto" ref={ref}>
        ...
        <div className="card shadow-lg">
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              query the DOM using a ref to find its current value when you need it. This is a bit
        ...
        <div className="card shadow-lg">
          <div className="card-body">
            ...
            <p className="card-text">
              React PropTypes are a good way to validate props coming into components. You can
              specify the type of prop you’re expecting, and if an invalid prop is passed, you’ll
        ...
        <div className="card shadow-lg">
          <div className="card-body">
            ...
            <p className="card-text">
              Node.js is a runtime environment for JavaScript that runs on the server. Express.js is
              a framework based on Node.js that helps you manage a server and routes easier.
              <br />
        ...
        <div className="card shadow-lg">
          <div className="card-body">
            ...
            <p className="card-text">
              A custom hook is a function that starts with use and that may call other hooks. A
              custom hook doesn’t need to have a specific signature. We can decide what it takes as
      ...
      <div className="flex justify-center mt-6">
        <Pdf targetRef={ref} filename="code.pdf" scale={0.7}>
          {({ toPdf }) => (
